...
public class Vehicle {
    ...
    private static final double MAX_SPEED = 5 / 400d;
    private static final double MAX_FORCE = 0.2 / 400d;

    private static final double CRASH_DISTANCE = 5 / 400d;
    @Getter
    private final double vechileWidth = 1 / 40d;
    @Getter
    private final double vehicleHeight = 5 / 400d;

    private final double sight = 1 / 4d;
    ...
    public void look(List<Boundary> walls) {
        ...
        for (int i = 0; i < rays.size(); i++) {
            ...
            if (rec < CRASH_DISTANCE) { // vehicle crashed in the wall
                dead = true;
                return;
            }
    ...
    public boolean equals(Object obj) {
        return obj instanceof Vehicle v && v.id.equals(id);
    }
}
